...
class AccountSummaryViewController: UIViewController {
    ...
    lazy var logoutBarButtonItem: UIBarButtonItem = {                                                                           //Will only be instantiated when it is called
...
extension AccountSummaryViewController {
    func FetchData() {
        ...
        let investment2 = AccountSummaryCell.ViewModel(accountType: .Investment, accountName: "Tax-free Saver", balance: 15000.00)
